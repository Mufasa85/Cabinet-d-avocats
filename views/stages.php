                        ...
                        <div class="stagiaire-card animate-on-scroll">
                            <a href="#" class="stagiaire-card-link">
                                ...
                                <div class="stagiaire-info">
                                    <h3 class="stagiaire-nom"><?= htmlspecialchars($stagiaire['fullname'] ?? trim(($stagiaire['prenom'] ?? '') . ' ' . ($stagiaire['nom'] ?? ''))) ?></h3>
                                    <p class="stagiaire-univ"><?= htmlspecialchars($stagiaire['universite'] ?? 'Université') ?></p>
                                    <span class="stagiaire-badge"><?= htmlspecialchars($stagiaire['niveau_etude'] ?? 'Stagiaire') ?></span>
                                </div>
                            </a>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <p style="text-align:center;padding:2rem;color:#666;">Aucun staitaire pour le moment.</p>
                <?php endif; ?>
            </div>
        ...
        <div class="container">
            <div class="application-wrapper">
                ...
                <div class="application-form-wrapper animate-on-scroll">
                    <form id="applicationForm" class="application-form" method="post" action="<?= htmlspecialchars($applyUrl ?? Router\Router::route('/stages/candidature')) ?>" enctype="multipart/form-data" novalidate>
                        <?= $csrf ?? '' ?>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label for="field">Domaine souhaité *</label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                <label for="motivation">Expliquez votre motivation pour ce stage *</label>
                                <textarea id="motivation" name="motivation" rows="5" required placeholder="Décrivez votre parcours, vos motivations et ce que vous souhaitez apporter au cabinet..."></textarea>
                                <span class="form-error"></span>
                            </div>
                        </div>
                        <div class="form-section">
