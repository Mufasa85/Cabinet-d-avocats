                ...
                <div class="article-pdf-section">
                    <div class="pdf-download-card">
                        ...
                        <div class="pdf-info">
                            ...
                            <p>Télécharger la version PDF complète de cet article</p>
                        </div>
                        <a href="<?= \Service\FileStorage::url($article['pdf_file']) ?>" target="_blank" rel="noopener" class="btn btn-primary pdf-download-btn">
